...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (unsigned int i = 0; i < 10; i++)
		{
			...
			view = glm::rotate(view, glm::radians((float)yRot), glm::vec3(1.0f, 0.0f, 0.0f)); // the final argument determines axis of rotation, somehow
			view = glm::rotate(view, glm::radians((float)xRot), glm::vec3(0.0f, 0.0f, 1.0f)); // This rotation seems wrong, I'm misunderstanding something
			view = glm::rotate(view, glm::radians((float)zRot), glm::vec3(0.0f, 1.0f, 0.0f));
